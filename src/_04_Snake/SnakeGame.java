...
int randomX = ran.nextInt(SnakeGame.WIDTH);
int randomY = ran.nextInt(SnakeGame.HEIGHT);
...
String playagain = JOptionPane.showInputDialog("Do you want to continue");
if (playagain == null) {
	System.exit(0);
}
